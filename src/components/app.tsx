...
function TypesSelect({
  ...
  return (
    ...
    >
      ...
      {schema ? (
        <select
          className="min-w-0 w-60 text-sm mt-0 border-gray-200 rounded focus:ring focus:ring-offset-0 focus:border-gray-400 focus:ring-gray-100 focus:ring-gray-100 focus:outline-none"
          value={value}
          onChange={(e) =>
            onChange({
